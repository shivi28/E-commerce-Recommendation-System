...
# Import moved inside class to avoid circular imports
class Offer(models.Model):
    # Import Company from user_login.models
    from user_login.models import Company
...
class Click(models.Model):
    # Import Customer from user_login.models
